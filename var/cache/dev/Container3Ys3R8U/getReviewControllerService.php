...
class getReviewControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator..IE9IEg'] ?? $container->load('get_ServiceLocator__IE9IEgService'))->withContext('App\\Controller\\ReviewController', $container));
