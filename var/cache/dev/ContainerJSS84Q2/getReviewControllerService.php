...
class getReviewControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.DweWeAE'] ?? $container->load('get_ServiceLocator_DweWeAEService'))->withContext('App\\Controller\\ReviewController', $container));
