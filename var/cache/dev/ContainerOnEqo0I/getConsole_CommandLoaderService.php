...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Command\\AddProductCommand' => ['privates', '.App\\Command\\AddProductCommand.lazy', 'getAddProductCommand_LazyService', true],
            'App\\Command\\DiscoverProfitShareCommand' => ['privates', '.App\\Command\\DiscoverProfitShareCommand.lazy', 'getDiscoverProfitShareCommand_LazyService', true],
            'App\\Command\\GenerateLinkCommand' => ['privates', '.App\\Command\\GenerateLinkCommand.lazy', 'getGenerateLinkCommand_LazyService', true],
            'App\\Command\\GenerateSitemapCommand' => ['privates', '.App\\Command\\GenerateSitemapCommand.lazy', 'getGenerateSitemapCommand_LazyService', true],
            'App\\Command\\MigrateCategoriesCommand' => ['privates', '.App\\Command\\MigrateCategoriesCommand.lazy', 'getMigrateCategoriesCommand_LazyService', true],
            'App\\Command\\QuickScrapeCampaignCommand' => ['privates', '.App\\Command\\QuickScrapeCampaignCommand.lazy', 'getQuickScrapeCampaignCommand_LazyService', true],
            'App\\Command\\ScrapeAlleopCommand' => ['privates', '.App\\Command\\ScrapeAlleopCommand.lazy', 'getScrapeAlleopCommand_LazyService', true],
            'App\\Command\\ScrapeCampaignCommand' => ['privates', '.App\\Command\\ScrapeCampaignCommand.lazy', 'getScrapeCampaignCommand_LazyService', true],
            'App\\Command\\ScrapeEmagCommand' => ['privates', '.App\\Command\\ScrapeEmagCommand.lazy', 'getScrapeEmagCommand_LazyService', true],
            'App\\Command\\ScrapeEmagHtmlCommand' => ['privates', '.App\\Command\\ScrapeEmagHtmlCommand.lazy', 'getScrapeEmagHtmlCommand_LazyService', true],
            'App\\Command\\ScrapeFashionDaysCommand' => ['privates', '.App\\Command\\ScrapeFashionDaysCommand.lazy', 'getScrapeFashionDaysCommand_LazyService', true],
            'App\\Command\\ScrapeProductCommand' => ['privates', '.App\\Command\\ScrapeProductCommand.lazy', 'getScrapeProductCommand_LazyService', true],
            'App\\Command\\TestAffiliateLinkCommand' => ['privates', '.App\\Command\\TestAffiliateLinkCommand.lazy', 'getTestAffiliateLinkCommand_LazyService', true],
            'App\\Command\\TestApiCommand' => ['privates', '.App\\Command\\TestApiCommand.lazy', 'getTestApiCommand_LazyService', true],
            'App\\Command\\TestConnectionCommand' => ['privates', '.App\\Command\\TestConnectionCommand.lazy', 'getTestConnectionCommand_LazyService', true],
            'App\\Command\\UpdateCategoriesCommand' => ['privates', '.App\\Command\\UpdateCategoriesCommand.lazy', 'getUpdateCategoriesCommand_LazyService', true],
            ...
            'App\\Command\\DiscoverProfitShareCommand' => '?',
            'App\\Command\\GenerateLinkCommand' => '?',
            'App\\Command\\GenerateSitemapCommand' => '?',
            'App\\Command\\MigrateCategoriesCommand' => '?',
            'App\\Command\\QuickScrapeCampaignCommand' => '?',
            'App\\Command\\ScrapeAlleopCommand' => '?',
            'App\\Command\\ScrapeCampaignCommand' => '?',
            'App\\Command\\ScrapeEmagCommand' => '?',
            'App\\Command\\ScrapeEmagHtmlCommand' => '?',
            'App\\Command\\ScrapeFashionDaysCommand' => '?',
            'App\\Command\\ScrapeProductCommand' => '?',
            'App\\Command\\TestAffiliateLinkCommand' => '?',
            'App\\Command\\TestApiCommand' => '?',
            'App\\Command\\TestConnectionCommand' => '?',
            'App\\Command\\UpdateCategoriesCommand' => '?',
